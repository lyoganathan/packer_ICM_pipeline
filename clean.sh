...
#bash aliases
echo "alias dcm2nii='/home/vagrant/mricron_lx/dcm2nii'" > .bash_aliases
echo "alias mricron='/home/vagrant/mricron_lx/mricron'" >> .bash_aliases
echo "alias mipav='/home/vagrant/mipav/mipav'" >> .bash_aliases
